package com.wshuman3.weighttracker.utility;
...
import com.wshuman3.weighttracker.MyApplication;
...
public class Utility {
	...
	public static boolean importWeightDatafromSD() {
    	...
    	try {
    		...
    		String applicationDBPath = "/data/com.wshuman3.weighttracker/databases/weighttracker";
    		String backupDBPath = "com.wshuman3.weighttracker/weighttracker";
	...
	public static boolean saveWeightDatatoSD() {
    	...
    	try {
    		...
    		if (sd.canWrite()) {
	    		...
	    		String currentDBPath = "/data/com.wshuman3.weighttracker/databases/weighttracker";
	    		
	
	    		File currentDB = new File(data, currentDBPath);
	    		File backupDBPath = new File(sd, "com.wshuman3.weighttracker");
	...
	public static boolean saveWeightFiletoSD() {
		...
		if (sd.canWrite()) {
    		...
    		File backupFilePath = new File(sd, "com.wshuman3.weighttracker");
